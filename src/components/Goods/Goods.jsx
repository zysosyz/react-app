...
export default function () {
    ...
    return <>
        <div className='goodslist'>
            <div className='title'>
                <FontAwesomeIcon icon={faFire} beat style={{ color: 'red', marginRight: '5px' }} />
                商品排行榜
                <span className='more'>更多<FontAwesomeIcon icon={faAngleUp} rotation={90} /></span>
            </div>
            {goods.length > 0 && goods.map(item =>
                <div className='goods_item' key={item.id} onClick={() => {
                    ...
                    <div className='item_img'>
                        <Lazyimg src={item.image} style={{height:'100px',lineHeight:'100px'}}   placeholder={<Loading style={{height:'100px',lineHeight:'100px'}} size={35} type='spinner' />}></Lazyimg>
                        {/* <img src={item.image} /> */}
                    </div>
