...
import { Toast, NavBar, SubmitBar, Checkbox, SwipeCell, ProductCard, Button, Stepper, Empty } from 'react-vant'
...
export default () => {
    ...
    return (
        <div className='CartPage'>
            ...
            />
            <div className='goods'>
                <Checkbox.Group value={checkList} checkedColor='#ff0000' onChange={(checkedList) => {
            ...
            >
                <Checkbox checked={checked} checkedColor='#ff0000' onClick={() => {
                    // console.log(111);
                    setChecked(!checked)
                    if (cart.length > 0) {
                        let totalPrice = 0
